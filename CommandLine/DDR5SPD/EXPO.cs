...
namespace DDR5XMPEditor.DDR5SPD
{
    public class EXPO : PropertyChangedBase
    {
        ...
        public static readonly ushort EXPOProfileSize = 0x28;                         //cjin
        public static readonly ushort EXPOHeaderSize = 0xA;
        public static readonly byte[] EXPOHeaderMagic = { 0x45, 0x58, 0x50, 0x4F };   //EXPO

        [StructLayout(LayoutKind.Sequential, Pack = 1)]

        public unsafe struct RawEXPOHeader
        {
            public fixed byte magic[4];  //Byte 0x340 0x341 0x342 0x343 //0x45 0x58 0x50 0x4F
            public byte version;         //Byte 0x344 //[7:4}Major Version [3:0]Minor Version   
            public byte config;          //[7:5]Profile1 Config bit4: Profile1 Enable, [3:1]Profile1 Config bit0:Profile0 Enable
            public byte profileEnabled;  //bit4 : profile1 enabled,  bit0 : profile0 enabled
            public byte zero_8;
            public byte zero_9;
            public byte zero_A;
        };
        ...
        [StructLayout(LayoutKind.Sequential, Pack = 1)]
        public unsafe struct RawEXPOProfile                     //Size = 40byte
        {
            //EXPO Profile Parameter Block 0 
            public byte vdd;
            public byte vddq;
            public byte vpp;
            public byte zero_4;
            ...
            //EXPO Profile Parameter Block 1
        ...
        {
            public RawEXPOHeader header;                            //Size = 10 
            public RawEXPOProfile profile1;                         //Size = 40 
            public RawEXPOProfile profile2;                         //Size = 40 
            public fixed byte filler[0x24];                         //Size = 36   128 - ( 10 + 40 + 40 + 2)
        ...
        public unsafe double? Frequency
        {
            get
            {
                ushort frq = Utilities.ConvertBytes(rawEXPOProfile.minCycleTime[0], rawEXPOProfile.minCycleTime[1]);
